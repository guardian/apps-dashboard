...
function generateChart(callback) {
	...
	report.request("Report.Queue", reportData, function(err, response){
		...
		chart.series = highChartSeriesFrom(response).map(function(elem){elem.name = Util.abbreviatedAndroidVersionNumber(elem.name);return elem});
