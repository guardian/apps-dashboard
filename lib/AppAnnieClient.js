...
AppAnnieClient.prototype.getGooglePlayReviews = function (startDate, endDate, rating, callback) {
	var url = 'https://api.appannie.com/v1.2/apps/google-play/app/' + module.androidProductID + '/reviews?start_date=' + startDate + '&end_date=' + endDate + '&rating=' + rating;
